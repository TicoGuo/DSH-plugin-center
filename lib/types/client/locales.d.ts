...
export type PluginCenterKey = 'view.pluginCenter' | 'toolbar.aria' | 'search' | 'filter.all' | 'filter.installed' | 'filter.updatable' | 'filter.disabled' | 'refresh' | 'stats' | 'status.notInstalled' | 'status.enabled' | 'status.disabled' | 'status.updateAvailable' | 'action.install' | 'action.uninstall' | 'action.update' | 'action.enable' | 'action.disable' | 'detail.version' | 'detail.installedVersion' | 'detail.author' | 'detail.repository' | 'detail.changelog' | 'detail.requirements' | 'detail.requirementsEmpty' | 'confirm.uninstallTitle' | 'confirm.uninstallBody' | 'confirm.cancel' | 'confirm.confirm' | 'toast.install' | 'toast.uninstall' | 'toast.update' | 'toast.enable' | 'toast.disable' | 'toast.failed' | 'loading' | 'error' | 'retry' | 'empty' | 'emptySearch' | 'disabled' | 'githubError' | 'card.title' | 'card.description' | 'card.enable';
