...
export function PluginCenterView({ t, list, refresh, install, uninstall, update, setEnabled, featureEnabled, setFeatureEnabled, }) {
    ...
    const enableFeature = useCallback(() => {
        ...
        void setFeatureEnabled(true).catch((error) => {
    ...
    if (featureEnabled === false) {
        return (_jsxs("div", { className: css.disabled, role: "status", children: [_jsx("p", { children: t('disabled') }), _jsx("button", { type: "button", disabled: featureBusy, onClick: enableFeature, children: featureBusy ? t('loading') : t('enableFeature') }), featureError !== null ? _jsx("p", { className: css.error, role: "alert", children: featureError }) : null] }));
    }
