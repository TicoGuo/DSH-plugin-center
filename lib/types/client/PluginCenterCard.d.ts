...
export declare function PluginCenterCard({ t, useCard, toggle, }: InjectFace<PluginCenterCardFace> & PropsLocale<'pluginCenter'>): ReactNode;
//# sourceMappingURL=PluginCenterCard.d.ts.map