 ...
 */
export function entryState(entry, plugins, installedVersion, availableVersion) {
 ...
 */
export function mergeCatalog(registry, plugins, installedVersions, availableVersions = EMPTY_VERSIONS) {
