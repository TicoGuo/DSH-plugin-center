window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css2 = ".pcSb_button{display:flex;align-items:center;gap:6px;width:100%;height:38px;padding:8px 16px;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-radius:12px;background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;cursor:pointer}.pcSb_button:hover{background:var(--dsw-alias-button-floating-hover)}.pcSb_buttonRail{display:flex;align-items:center;justify-content:center;width:36px;height:36px;border:1px solid transparent;border-radius:12px;background:transparent;cursor:pointer}.pcSb_buttonRail:hover{background:var(--dsw-alias-interactive-bg-hover)}.pcSb_icon{flex:none;font-size:16px;line-height:1}.pcSb_label{overflow:hidden;white-space:nowrap}.pcSb_overlay{position:fixed;top:0;right:0;bottom:0;z-index:1000;display:flex;flex-direction:column;padding:24px 28px;box-sizing:border-box;background:var(--dsw-alias-bg-layer-1)}";
