window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/PluginCenterCard.module.css.mjs
		...
		const css2 = ".pcSb_button{flex:none;display:flex;align-items:center;justify-content:center;gap:6px;width:100%;height:38px;padding:8px 16px;margin:0 2px 8px;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-radius:12px;background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;cursor:pointer;overflow:hidden}.pcSb_button:hover{background:var(--dsw-alias-button-floating-hover)}.pcSb_buttonRail{display:flex;align-items:center;justify-content:center;width:36px;height:36px;padding:0;border:1px solid transparent;border-radius:12px;background:transparent;cursor:pointer}.pcSb_buttonRail:hover{background:var(--dsw-alias-interactive-bg-hover)}.pcSb_label{max-width:200px;overflow:hidden;white-space:nowrap}.pcSb_overlay{position:fixed;top:0;right:0;bottom:0;z-index:1000;display:flex;flex-direction:column;box-sizing:border-box;background:var(--dsw-alias-bg-base)}";
		...
		function PluginCenterSidebarButton({ t, wide, list, refresh, install, uninstall, update, setEnabled }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCordisPluginOutline14, { size: wide ? 14 : 18 }), wide && (0, react_jsx_runtime.jsx)("span", {
