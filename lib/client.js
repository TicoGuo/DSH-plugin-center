	...
	factory: (require) => {
		...
		*/
		...
		var PluginCenterView_module_css_default = {
			...
			"filterActive": "rswBTa_filterActive",
			"stars": "rswBTa_stars",
			"search": "rswBTa_search",
			"filterPill": "rswBTa_filterPill",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: PluginCenterView_module_css_default.filters,
						role: "tablist",
						...
						children: PLUGIN_CENTER_FILTERS.map((option) => (0, react_jsx_runtime.jsx)("button", {
							...
							className: filter === option ? PluginCenterView_module_css_default.filterActive : PluginCenterView_module_css_default.filterPill,
							onClick: () => {
								setFilter(option);
							},
