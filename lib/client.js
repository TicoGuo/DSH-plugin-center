window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function PluginCenterView({ t, switchView, list, refresh, install, uninstall, update, setEnabled }) {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("header", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							}), (0, react_jsx_runtime.jsx)("button", { type: "button", className: PluginCenterView_module_css_default.backButton, onClick: () => { switchView === null || switchView === void 0 ? void 0 : switchView("chat"); }, children: t("backToChat") })]
						})]
					}),
		...
		*/
		...
		function PluginCenterSidebarButton({ t, wide, open }) {
		...
		function apply(ctx) {
			...
			ctx.slots.inject("sidebar.header.action", () => ctx.slots.register({
				...
				inject: () => ({
					open: () => {
						const switcher = ctx.get("conversationViewSwitch");
						switcher === null || switcher === void 0 ? void 0 : switcher.switch("plugin-center");
					}
				})
